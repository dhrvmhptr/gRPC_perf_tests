...
| 36,868,988 | __GI___libc_write -> [unknown] |
| 32,957,440 | ThreadBody -> WorkSignal::WaitWithTimeout |
| 31,178,633 | ReceiveMessage::OnComplete -> __GI___libc_write |
| 30,243,050 | TcpSend -> __libc_sendmsg |
...
|-------|----------|
| 331 | [unknown] |
| 126 | std::__is_constant_evaluated |
